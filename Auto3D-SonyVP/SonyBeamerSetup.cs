...
{
  public partial class SonyBeamerSetup : UserControl, IAuto3DSetup
  {
    SonyBeamer _device;

    public SonyBeamerSetup(IAuto3D device)
    {
      InitializeComponent();

      if (!(device is SonyBeamer))
        throw new Exception("Auto3D: Device is no Sony Beamer");

      _device = (SonyBeamer)device;
